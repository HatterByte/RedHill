            ...
            <form className={`mt-6 relative ${disabled ? "opacity-[0.6]" : ""}`} onSubmit={(e) =>{handleSubmit(e)}}>
                ...
                <div className="w-full flex justify-between">
                    ...
                    <div className="w-[48%] mt-3">
                        ...
                        <select className={`w-full border-[1px] h-13 border-[#d9d9d9] p-2 text-2xl  bg-[#f4f5f6] rounded-lg focus:outline-1 focus:outline-[#bbbbbb] mt-1`} value={formData.type} onChange={(e) => { setFormData({ ...formData, type: e.target.value }); }} >
                    ...
                    <div className="w-[48%] mt-3">
                        ...
                        <select className='w-full border-[1px] h-13 border-[#d9d9d9] p-2 text-2xl  bg-[#f4f5f6] rounded-lg focus:outline-1 focus:outline-[#bbbbbb] mt-1' value={formData.subtype} onChange={(e) => { setFormData({ ...formData, subtypetype: e.target.value }); }} >
