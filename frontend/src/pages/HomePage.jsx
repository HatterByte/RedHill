...
const HomePage = () => {
    ...
    return (
        <div className="h-auto min-h-screen w-full flex flex-col">
            <ResponsiveNavbar />
            <div className="flex flex-col-reverse items-center min-[1150px]:items-start min-[1150px]:flex-row min-[1150px]:justify-between p-10 w-full h-auto min-h-full">
                ...
                <div className="min-[1150px]:w-7/12 box-border flex justify-center min-[1150px]:m-8 min-h-full">
